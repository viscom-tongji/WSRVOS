...
class ReferYouTubeVOSDataset(Dataset):
    ...
    """
    def __init__(self, subset_type: str = 'train', dataset_path: str = 'data/refer_davis',
    ...
    def __getitem__(self, idx):
        ...
        if self.subset_type == 'train':
            with open(path.join(self.dataset_path, 'train', 'meta.json'), 'r') as f:
