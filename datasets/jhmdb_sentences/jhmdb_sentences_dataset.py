...
class JHMDBSentencesDataset(Dataset):
    ...
    """
    def __init__(self, subset_type: str = 'test', dataset_path: str = 'data/jhmdb_sentences', window_size=8,
                 generate_new_samples_metadata=False, distributed=False, dataset_coco_gt_format_path=None,**kwargs):
    ...
    def get_samples_metadata(root_path, generate_new_samples_metadata, distributed):
        ...
        if path.exists(samples_metadata_file_path) and not generate_new_samples_metadata:
